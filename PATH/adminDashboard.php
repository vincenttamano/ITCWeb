...
<body>
        ...
        <div class="tab-content-container">
            ...
            <div id="view-alumni" class="tab-content active">
                ...
                <div id="singleAlumnusView" class="single-alumnus-details" style="display: none;">
                    <h4>Alumnus Details</h4>
                    <div id="alumnusDetailsContent">
                        Loading details...
                    </div>
                    <button id="backToListBtn" class="back-to-list-btn">Back to Search Results</button>
                    <button id="editRecordBtn" class="back-to-list-btn" style="background-color:#337ab7; margin-left:auto;">Edit Record</button>
    ...
    <script>
        ...
        // Removed fetchData() and fetchIncompleteData() as full list is not on this page
        ...
        function displaySingleAlumnus(alumniId) {
            ...
            // This PHP file fetches data for a single alumnus by ID
            ...
            xhr.onload = function() {
                if (xhr.status >= 200 && xhr.status < 300) {
                    ...
                    if (response.success && response.data) {
                        ...
                        // Format and display the alumnus details
        ...
        // Add this to your <script> section, after DOMContentLoaded
        document.addEventListener('DOMContentLoaded', function() {
            const editRecordBtn = document.getElementById('editRecordBtn');
            if (editRecordBtn) {
                editRecordBtn.addEventListener('click', function() {
                    // Get the currently viewed alumni_id from the details (or URL)
                    const urlParams = new URLSearchParams(window.location.search);
                    const alumniId = urlParams.get('alumni_id');
                    if (alumniId) {
                        // Switch to Update Alumni tab and auto-populate the form
